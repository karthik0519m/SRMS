...
<body>
    ...
    ?>
    <div class="container">
    <div style="margin-bottom: 10px;"><a href="show_result.php" style="display: flex; font-size: 20px; gap:10px; text-decoration: none; font-weight: bold;"> <span>&larr;</span> Back</a></div>
        <div class="details">
